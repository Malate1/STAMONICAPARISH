...
<title><?= isset($page_title) ? $page_title . ' | ' : '' ?>Parish Office - Sta. Monica Parish Connect</title>
...
<div class="flex h-screen overflow-hidden">
  <?php $this->load->view('partials/sidebar_backoffice', ['current_user' => $current_user]); ?>
