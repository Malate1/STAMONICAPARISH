...
// Parish operates in the Philippines. Keep application date/time comparisons
// (publish dates, expirations, schedules, etc.) aligned with local parish time.
...
$config['sess_cookie_name'] = 'stamonica_session';
