...
CREATE TABLE chapel_mass_schedules (
    id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    ...
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (chapel_id) REFERENCES chapels(id) ON DELETE CASCADE,
    INDEX idx_chapel_mass_order (chapel_id, day_of_week, mass_time, display_order)
) ENGINE=InnoDB;

CREATE TABLE gsk_clusters (
    id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    chapel_id INT UNSIGNED NOT NULL,
    name VARCHAR(180) NOT NULL,
...
CREATE TABLE church_officials (
    ...
    updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (chapel_id) REFERENCES chapels(id) ON DELETE CASCADE,
    FOREIGN KEY (cluster_id) REFERENCES gsk_clusters(id) ON DELETE CASCADE,
